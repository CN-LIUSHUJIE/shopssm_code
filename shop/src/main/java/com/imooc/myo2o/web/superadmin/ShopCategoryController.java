...
public class ShopCategoryController {
    ...
    private Map<String, Object> listShopCategorys() {
        ...
        try {
            list = shopCategoryService.queryShopCategory();
    ...
    @ResponseBody
    private Map<String, Object> modifyShopCategory(HttpServletRequest request) throws UnsupportedEncodingException {
        Map<String, Object> modelMap = new HashMap<String, Object>();
        ...
        CommonsMultipartFile thumbnail = (CommonsMultipartFile) multipartRequest.getFile("shopCategoryManagementEdit_shopCategoryImg");
        try {
        ...
        if (shopCategory != null && shopCategory.getShopCategoryId() != null) {
            try {
                ...
                ShopCategoryExecution ae = shopCategoryService.modifyShopCategory(shopCategory, thumbnail, thumbnailChange);
